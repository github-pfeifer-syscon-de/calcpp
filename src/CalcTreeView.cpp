...
void
CalcTreeView::create_column_name(Glib::ustring name, Gtk::TreeModelColumn<Glib::ustring>& col)
{
...
void
CalcTreeView::value_cell_data_func(Gtk::CellRenderer* cell, const Gtk::TreeModel::iterator& iter, int model_column)
{
...
void
CalcTreeView::create_column_value(Glib::ustring name, Gtk::TreeModelColumn<double>& col)
{
	...
	Gtk::TreeViewColumn::SlotTreeCellData slot =
		sigc::bind(
			sigc::mem_fun(*this, &CalcTreeView::value_cell_data_func), col.index());
